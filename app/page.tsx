...
export default async function Home() {
  ...
  const [stats, clubs] = await Promise.all([getLandingStats(), getPublicClubs()]);
  ...
  return (
    <div className="min-h-screen bg-background">
      <Hero locale={locale} t={translate} clubCount={stats.clubs} />
      <StatsBar t={translate} stats={stats} />
      <PlatformOverview t={translate} />
      <FeatureGrid t={translate} />
      <HowItWorks t={translate} />
      <UseCases t={translate} />
      <ClubDirectory t={translate} clubs={clubs} />
      <FinalCta t={translate} />
      <LandingFooter t={translate} />
    </div>
  );
}

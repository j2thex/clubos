...
export function NearMeButton({
  ...
  return (
    <button
      ...
      className="shrink-0 h-10 px-3 flex items-center justify-center gap-2 rounded-lg bg-landing-surface-hover border border-landing-border text-landing-text-secondary hover:text-landing-text hover:border-landing-border disabled:opacity-50 transition"
    >
      {loading ? (
        <div className="w-3.5 h-3.5 border border-landing-text-tertiary border-t-landing-text-secondary rounded-full animate-spin" />
      ) : (

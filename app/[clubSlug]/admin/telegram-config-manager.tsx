  ...
  function handleTest() {
    ...
    startTransition(async () => {
      ...
      if ("error" in result) {
        ...
        setMessage({ type: "success", text: "Test message sent! Check your Telegram group." });
      ...
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
        <div className="px-5 py-4 space-y-3">
          <p className="text-xs text-gray-400">
            Connect a Telegram bot to notify staff about pending quests, service requests, and RSVPs.
          </p>
          <div>
            ...
            />
            <p className="text-[10px] text-gray-400 mt-1">Get from @BotFather on Telegram</p>
          </div>
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-700 font-mono placeholder:text-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400 transition"
            />
            <p className="text-[10px] text-gray-400 mt-1">Group chat ID (starts with -100 for supergroups)</p>
          </div>
